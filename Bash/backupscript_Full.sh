...
then
      ...
      rsync -arqz --delete /srv/Path_to_folder_wanted_to_back_up /mnt/Path_to_Mounted_folder
      rsync -arqz --delete --exclude 'if_you_want_exclude' --exclude 'if_you_want_exclude' /and_back_Up_other /mnt/Path_to_Mounted_folder
